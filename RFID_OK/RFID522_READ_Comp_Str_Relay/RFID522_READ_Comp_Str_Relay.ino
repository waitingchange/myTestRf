...
/*
读取卡号（ID），以及Block1的前8个字节的内容（Str），如Block1的前8个字节的内容（Str）符合就触发继电器（Relay）。
Block1的前8个字节的内容（Str），可以通过《RFID522_Serial_write_block.ino》写入。

* 文 件 名：RFID522_READ_Comp_Str_Relay.ino
* 修 改 者：mc.six
...
//
//  if (str[0] == 'a' && str[1] == 'u' && str[2] == 'g' && str[3] == 'u' && str[4] == 's' && str[5] == 't' && str[6] == '0' && str[7] == '1' ) //根据需要手动修改每个的内容
//  {
//
//    digitalWrite(Relay, HIGH);		//打开继电器
//    Serial.println("The Host 1!");
//  }
//  else if (str[0] == 'a' && str[1] == 'b' && str[2] == 'c' && str[3] == 'd' && str[4] == 'e' && str[5] == 'f' && str[6] == 'g' && str[7] == 'h') //根据需要手动修改每个的内容
//  {
