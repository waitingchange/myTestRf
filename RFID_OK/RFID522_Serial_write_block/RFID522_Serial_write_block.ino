...
/*
再串口监视器的输入窗口输入想要输入的字符，然后回车
将需要写Block1的卡贴上去就会写入数据
如需要清除内容，输入16个或以上空格即可。



* 文 件 名：RFID522_Serial_write_block.ino
* 修 改 者：mc.six

* 功能描述：Mifare1 寻卡→防冲突→选卡→写Block1
*/
